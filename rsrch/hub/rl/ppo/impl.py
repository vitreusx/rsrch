...
def _get_slices(batch_size: int, num_mb: int):
    """Divide a batch into a number of minibatches. The minibatch sizes are
    selected in such a way, that they are divisible by 32, except for the last
    one. The last batch may be larger than the previous ones."""
