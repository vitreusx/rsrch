...
from typing import Generic, Callable, TypeVar, Sequence, Union
import numpy as np

X, Y = TypeVar("X"), TypeVar("Y")

class MapDataset(data.Dataset[Y]):
...
def random_split(ds: Dataset[X], lengths: Sequence[Union[int, float]]) -> Sequence[Dataset[X]]:
