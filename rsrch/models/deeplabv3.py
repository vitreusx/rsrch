...
def conv2d_set_dilation(conv: nn.Conv2d, dilation: int):
    ...
    # See [PyTorch docs](https://docs.pytorch.org/docs/stable/generated/torch.nn.Conv2d.html)
    # for conv output size arithmetic.
...
def convert_resnet_(
    ...
    The length of `dilations` indicates how many of the final layers to take. If
    `dilations[idx]` is a list, different dilation rates are applied to consecutive
    blocks in the layer. This is the multi-grid method in Subsection 3.2.1.
    """
