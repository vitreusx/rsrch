...
def main():
    p = argparse.ArgumentParser(
        description="A helper for deploying grid launches via SLURM. Pass extra"
        "arguments to sbatch by after -- (e.g. via_slurm.py -- -J <job_name>)",
    )
    p.add_argument(
        "--dry-run",
        action="store_true",
    ...
    p.add_argument(
        ...
        help="Path to a file with commands for the grid launch. Each line "
        "should contain a command to execute. Default: ./commands.txt",
    )
