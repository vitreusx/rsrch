...
\begin{enumerate}
  ...
  \item A2C uses generalized advantage estimation to compute the targets for the value functions, whereas CleanRL's SAC implementation uses a one-step bootstrap.
\end{enumerate}
