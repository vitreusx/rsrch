...
def adaptive_wm_ratio_v1_2(test_name, suffix=""):
    all_tests = []
...
def main():
    ...
    p.add_argument("--name", default="adaptive_wm_ratio_v1_2")
    args = p.parse_args()

    all_tests = adaptive_wm_ratio_v1_2(args.name)
