...
def final_prelim2(test_name: str, suffix=""):
    all_tests = []
    ...
    common_opts = {"env.atari.repeat_action_probability": 0.0}
...
def main():
    ...
    p.add_argument("--name", default="final/prelim2")
    args = p.parse_args()

    all_tests = final_prelim2(args.name)
