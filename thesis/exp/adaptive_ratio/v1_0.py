...
def adaptive_ratio_v1_0(test_name, suffix=""):
    all_tests = []
...
def main():
    ...
    p.add_argument("--name", default="adaptive_ratio/v1_0")
    args = p.parse_args()

    all_tests = adaptive_ratio_v1_0(args.name)
