...
These considerations lead us to a choice of four Atari games: Pong, Crazy Climber, Assault and Asterix. The performance curves can be seen in \autoref{fig:a100k_mono_perf}.

\begin{figure}
  \includegraphics[width=\linewidth]{assets/perf_curves.pdf}
  \caption{Performance curves for a four-game subset of Atari-100k. The dashed line denotes mean score when choosing random actions. The colored lines represent different RNG seeds chosen.}
